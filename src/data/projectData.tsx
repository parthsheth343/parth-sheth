...
export const projectData: ProjectT[] = [
    {
        ...
        imageSrc: `${process.env.PUBLIC_URL}/petpal.png`,
        description:
    ...
    //         <PythonBadge />,
    //     ],
    //     imageSrc: `${process.env.PUBLIC_URL}/street-savvy.jpg`,
    //     description:
    ...
    //     imageSrc: `${process.env.PUBLIC_URL}/twitter-geo-sentiment.jpg`,
    //     description:
    ...
    //     imageSrc: `${process.env.PUBLIC_URL}/fourier-series.png`,
    //     description:
    ...
    //     tags: [<PythonBadge />],
    //     imageSrc: `${process.env.PUBLIC_URL}/orbital-sim.png`,
    //     description:
    ...
    //     imageSrc: `${process.env.PUBLIC_URL}/plismun.jpg`,
    //     description:
    ...
    //     tags: [<ReactBadge />, <TypescriptBadge />],
    //     imageSrc: `${process.env.PUBLIC_URL}/photography-portfolio.png`,
    //     description:
    ...
    //         <MongoBadge />,
    //     ],
    //     imageSrc: `${process.env.PUBLIC_URL}/linky.png`,
    ...
    //     tags: [<JavaBadge />],
    //     imageSrc: `${process.env.PUBLIC_URL}/blogging-app.jpg`,
    //     description:
    ...
    //     tags: [<AssemblyBadge />],
    //     imageSrc: `${process.env.PUBLIC_URL}/breakout-asm.png`,
    //     description:
